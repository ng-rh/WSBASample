...
public class ScenarioBHotelProviderBEMailCompensationHandler implements CompensationHandler
{
	...
	{		
		...
		if(customerIterator.hasNext())
		{
			...
			try 
			{
				EMailHelper.sendEMail("WSBA Hotel Provider B Person", to, "IMPORTANT: Your hotel cancellation", "It is with regret that I must inform you that we have had to cancel your hotel reservation due to the great room shortage of 2006.", bookingId);
			} 
