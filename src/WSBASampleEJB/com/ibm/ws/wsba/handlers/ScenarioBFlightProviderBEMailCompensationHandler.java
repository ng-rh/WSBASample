...
public class ScenarioBFlightProviderBEMailCompensationHandler implements CompensationHandler
{
	...
	public void compensate(DataObject dataObject) throws RetryCompensationHandlerException, CompensationHandlerFailedException 
	{
		...
		if(customerIterator.hasNext())
		{
			...
			try 
			{
				EMailHelper.sendEMail("WSBA Flight Provider B Person", to, "IMPORTANT: Your flight cancellation", "It is with regret that I must inform you that we have had to cancel your flight booking due to the great plane shortage of 2006.", bookingId);
			} 
