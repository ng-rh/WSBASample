...
public class ScenarioACompensationHandler implements CompensationHandler
{
	...
	{		
		...
		if(customerIterator.hasNext())
		{
			...
			try 
			{
				EMailHelper.sendEMail("WSBA Travel Agent Person", to, "IMPORTANT: Your holiday cancellation", "It is with regret that I must inform you that we have had to cancel your holiday due to the great holiday shortage of 2006.", bookingId);
			} 
