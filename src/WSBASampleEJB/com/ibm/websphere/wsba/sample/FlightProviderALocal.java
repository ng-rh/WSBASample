...
@Local
/**
 * Local interface for Enterprise Bean: FlightProviderA
 */
public interface FlightProviderALocal 
{
	public void scenarioB(String id, boolean compensate, String bookingId, Log log) throws BusinessException;
}