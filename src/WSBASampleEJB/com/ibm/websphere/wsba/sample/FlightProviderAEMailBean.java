...
/**
 * Bean implementation class for Enterprise Bean: FlightProviderAEMail
 */
@Stateless(name="FlightProviderAEMail")
@TransactionManagement(value=TransactionManagementType.CONTAINER) 
@TransactionAttribute(value=TransactionAttributeType.NOT_SUPPORTED) 

public class FlightProviderAEMailBean implements FlightProviderAEMailLocal
{
      @EJB
	...
	public void sendEMail(String from, String to, String subject, String body, String bookingId)
	{
		try
		{
			...
			log.addPEntry("In the Flight Provider A EMail stateless session bean.");
