...
/**
 * Bean implementation class for Enterprise Bean: FlightProviderBEMail
 */
@Stateless(name="FlightProviderBEMail")
@TransactionManagement(value=TransactionManagementType.CONTAINER) 
@TransactionAttribute(value=TransactionAttributeType.NOT_SUPPORTED) 

public class FlightProviderBEMailBean implements FlightProviderBEMailLocal
{
      @EJB
	...
	public void sendEMail(String from, String to, String subject, String body, String bookingId)
	{
		try
		{
			...
			log.addPEntry("In the Flight Provider B EMail stateless session bean.");
