...
/**
 * Bean implementation class for Enterprise Bean: FlightProviderB
 */
@Stateless(name="FlightProviderB")
@TransactionManagement(value=TransactionManagementType.CONTAINER) 
@TransactionAttribute(value=TransactionAttributeType.REQUIRES_NEW) 

public class FlightProviderBBean implements FlightProviderBLocal
{
      @EJB
      CustomerDataHelperLocal customerDataHelperLocal;
      @EJB
	FlightProviderBEMailLocal flightProviderBEMailLocal;

	public void scenarioB(String id, boolean throwBusinessException, String bookingId, Log log) throws BusinessException
	{
		log.addPEntry("In the Flight Provider B stateless session bean.");
		...
		try
		{
			...
			String from = "WSBA Flight Provider B Person";
			String airline = "WSBA Flight Provider B";
			...
			flightProviderBEMailLocal.sendEMail(from, id, "Your flight booking with Flight Provider B", "Congratulations, your flight has been booked, we at WSBA Flight Provider B hope you enjoy it.", bookingId);
		} 
