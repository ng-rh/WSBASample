...
/**
 * Bean implementation class for Enterprise Bean: HotelProviderA
 */
@WebService(
    portName="HotelProviderA",
    targetNamespace="http://www.ibm.com/websphere/sample/wsba",
    serviceName="HotelProviderAService",
    wsdlLocation="META-INF/wsdl/HotelProviderA.wsdl",
    endpointInterface="com.ibm.websphere.sample.wsba.HotelProviderA"
    )
@Stateless(name="HotelProviderA")
@TransactionManagement(value=TransactionManagementType.CONTAINER) 
@TransactionAttribute(value=TransactionAttributeType.REQUIRES_NEW) 

public class HotelProviderABean implements com.ibm.websphere.sample.wsba.HotelProviderA
{
      @EJB
	CustomerDataHelperLocal customerDataHelperLocal;
      @EJB
	HotelProviderAEMailLocal hotelProviderAEMailLocal;

      public HotelProviderABean() {}
	...
	public void scenarioB(String id, boolean throwBusinessException, String bookingId) throws BusinessException
	{
		...
		log.addPEntry("In the Hotel Provider A Web Service.");
		...
		try
		{
			...
			{
				throw new BusinessException("Intended Exception (HotelProviderA)", new com.ibm.ws.wsba.utils.BusinessException() );
			}
			
			String from = "WSBA Hotel Provider A Person";
			String hotel = "WSBA Hotel Provider A";
			...
			hotelProviderAEMailLocal.sendEMail(from, id, "Your hotel booking with Hotel Provider A", "Congratulations, your hotel has been booked, we at WSBA Hotel Provider A hope you enjoy it.", bookingId);
		} 
