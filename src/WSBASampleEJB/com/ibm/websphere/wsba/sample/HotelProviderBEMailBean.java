...
/**
 * Bean implementation class for Enterprise Bean: HotelProviderBEMail
 */
@Stateless(name="HotelProviderBEMail")
@TransactionManagement(value=TransactionManagementType.CONTAINER) 
@TransactionAttribute(value=TransactionAttributeType.NOT_SUPPORTED) 

public class HotelProviderBEMailBean implements HotelProviderBEMailLocal
{
      @EJB
	...
	public void sendEMail(String from, String to, String subject, String body, String bookingId)
	{
		...
		{				
			...
			log.addPEntry("In the Hotel Provider B EMail stateless session bean.");
